...
{
    public class ChemotherapyProtocolCycleDayMedicationMap : ClassMap<ChemotherapyProtocolCycleDayMedication>
    {
        public ChemotherapyProtocolCycleDayMedicationMap()
        {
            Table("ChemotherapyProtocolCycleDayMedication");
            Map(x => x.DateLastChange).Not.Nullable();
            Map(x => x.UserLastChange).Not.Nullable();

            Id(x => x.Id);

            References(x => x.ChemotherapyProtocolCycleDay)
                .Column("ChemotherapyProtocolCycleDayId").Not.Nullable();
